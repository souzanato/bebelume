...
export default function Edit({ attributes, setAttributes, clientId }) {
  ...
  const blockProps = useBlockProps({ className: 'editor-andar-castelinho-bebelume' });
  ...
  return (
    <>
      <InspectorControls>
        <PanelBody title={__('Configurações do Andar Castelinho', 'bebelume-theme')}>
          <MediaUploadCheck>
            <MediaUpload
      ...
      <div {...blockProps}>
        <div
          className="bebelume-andar-castelinho-preview"
          style={{
        ...
        >
          ...
          <div style={{ transform: invertLayout ? 'scaleX(-1)' : 'none' }}>
            ...
            >
              🏠 {__('Andar Castelinho', 'bebelume-theme')}
            </div>
