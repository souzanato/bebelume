...
export default function Edit({ attributes, setAttributes, clientId }) {
  ...
  const blockProps = useBlockProps({ className: 'editor-andar-casinha-bebelume' });
  ...
  return (
    <>
      <InspectorControls>
        <PanelBody title={__('Configurações do Andar Casinha Bebelume', 'bebelume-theme')}>
          <MediaUploadCheck>
            <MediaUpload
      ...
      <div {...blockProps}>
        <div
          className="preview-andar-casinha-bebelume"
          style={{
        ...
        >
          ...
          <div style={{ transform: invertLayout ? 'scaleX(-1)' : 'none' }}>
            ...
            >
              🏠 {__('Andar Casinha Bebelume', 'bebelume-theme')}
            </div>
