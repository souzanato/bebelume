...
export default function Edit({ attributes, setAttributes }) {
    ...
    const blockProps = useBlockProps({
        className: 'editor-telhado-casinha-bebelume',
    });

    return (
        <>
            <InspectorControls>
                <PanelBody title={__('Configurações do Telhado da Casinha Bebelume', 'bebelume-theme')}>
            ...
            <div {...blockProps}>
                <div 
                    className="preview-telhado-casinha-bebelume"
                    style={{
                ...
                >
                    <p style={{ 
                        ...
                        🏠 {__('Telhado da Casinha Bebelume', 'bebelume-theme')}
                    </p>
