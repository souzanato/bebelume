...
export default function Edit({ attributes, setAttributes }) {
    ...
    const blockProps = useBlockProps({
        className: 'bebelume-telhado-editor',
    });

    return (
        <>
            <InspectorControls>
                <PanelBody title={__('Configurações do Telhado', 'bebelume-theme')}>
            ...
            <div {...blockProps}>
                <div 
                    className="bebelume-telhado-preview"
                    style={{
                ...
                >
                    <p style={{ 
                        ...
                        🏠 {__('Telhado da Casa Bebelume', 'bebelume-theme')}
                    </p>
